...
mph = 60.0  # minutes per hour
hpd = 24.0  # hours per day
spd = spm * mph * hpd
spy = spd * 365.0
mpy = 12.0  # months per year
...
g_per_Pg = 1e15  # grams per Pg
g_per_kg = 1e3  # grams per kg
...
CO2_molar_mass = C_molar_mass + 2.0 * O_molar_mass  # grams per mole

# Atmospheric constants
dry_air_molar_mass = (
    0.78084 * 2.0 * N_molar_mass
    + 0.20946 * 2.0 * O_molar_mass
    + 0.00934 * Ar_molar_mass
    + 0.00039445 * CO2_molar_mass
)  # grams per mole
dry_air_mass = 5.1352e21  # grams
dry_air_moles = dry_air_mass / dry_air_molar_mass
co2_g_per_ppm = dry_air_moles * CO2_molar_mass / 1.0e6
...
space_opts = {}
space_opts["timeint"] = {
    "name": "Temporally integrated period mean",
    "cmap": "choose",
    "sym": False,
    "ticks": None,
    "ticklabels": None,
...
space_opts["timeintremap"] = {
    "name": "Temporally integrated remapped period mean",
    "cmap": "choose",
    "sym": False,
    "ticks": None,
    "ticklabels": None,
...
space_opts["bias"] = {
    "name": "Temporally integrated period mean bias",
    "cmap": "bias",
    "sym": True,
    "ticks": None,
    "ticklabels": None,
...
space_opts["biasscore"] = {
    "name": "Temporally integrated period mean bias score",
    "cmap": "score",
    "sym": False,
    "ticks": None,
    "ticklabels": None,
...
space_opts["rmse"] = {
    "name": "Temporally integrated period mean rmse",
    "cmap": "YlOrRd",
    "sym": False,
    "ticks": None,
    "ticklabels": None,
...
space_opts["rmsescore"] = {
    "name": "Temporally integrated period mean rmse score",
    "cmap": "score",
    "sym": False,
    "ticks": None,
    "ticklabels": None,
...
space_opts["iavscore"] = {
    "name": "Interannual variability score",
    "cmap": "score",
    "sym": False,
    "ticks": None,
    "ticklabels": None,
...
space_opts["shift"] = {
    "name": "Temporally integrated mean phase shift",
    "cmap": "PRGn",
    "sym": True,
    "ticks": None,
    "ticklabels": None,
...
space_opts["shiftscore"] = {
    "name": "Temporally integrated mean phase shift score",
    "cmap": "score",
    "sym": False,
    "ticks": None,
    "ticklabels": None,
...
space_opts["phase"] = {
    "name": "Temporally integrated period mean max month",
    "cmap": "jet",
    "sym": False,
    "ticks": mid_months,
...
time_opts = {}
time_opts["spaceint"] = {
    "name": "Spatially integrated regional mean",
...
time_opts["accumulate"] = {
    "name": "Accumulated mean",
    "section": "Spatially integrated regional mean",
    "haslegend": False,
...
time_opts["cycle"] = {
    "name": "Spatially integrated regional mean cycle",
    "section": "Spatially integrated regional mean",
    "haslegend": False,
    "pattern": "MNAME_RNAME_cycle.png",
    "sidelbl": "ANNUAL CYCLE",
    "ticks": mid_months / 365.0 + 1850.0,
    "ticklabels": lbl_months,
    "ylabel": "unit",
}

time_opts["dtcycle"] = {
    "name": "Spatially integrated regional mean detrended cycle",
    "section": "Spatially integrated regional mean",
    "haslegend": False,

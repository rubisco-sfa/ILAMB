...
print """ 
%sDeprecation warning: demo/driver.py will be removed in a future
release. The recommended method of running ILAMB is now via the
installed executable script ilamb-run. See the documentation for
details.%s 
""" % (FAIL,ENDC)
